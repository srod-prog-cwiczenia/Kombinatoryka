...
\numzad
 ...
 $8$ wież (wieża porusza się w górę, w dół, w lewo lub w prawo
...
Mamy:
  $D_n = n! \cdot \sum_{k = 0}^n \frak{(-1)^k}{k!}$.
...
\numzad
Korzytając z jednej z możliwych interpretacji kombinatorycznych
liczb Fibonacciego (np że jest to liczba podziałów na kafelki
$2\times 1$ prostokąta $n\times 2$), etc.,etc.
(apeluję by zapoznać się - nawet pobieżnie - z tym obszernym artykułem:
